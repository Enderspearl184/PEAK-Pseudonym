...
public partial class Plugin : BaseUnityPlugin
{
    ...
    static PseudonymConfig BoundConfig = null!;
    ...
    private void Awake()
    {
        ...
        // load config
        BoundConfig = new PseudonymConfig(base.Config);
        
        Pseudonym.Nickname = BoundConfig.Nickname.Value;
        Pseudonym.ObscureSteamId = BoundConfig.ObscureSteamId.Value;

        // patch
        Harmony.CreateAndPatchAll(typeof(Pseudonym));
    }
}
